...
- (CGPathRef)newMaskPathForGuideFrame:(CGRect)guideFrame outerFrame:(CGRect)frame {
  ...
  [maskPath appendPath:[[UIBezierPath bezierPathWithRoundedRect:guideFrame cornerRadius:8] bezierPathByReversingPath]];
...
- (void)animateCardMask:(CGRect)guideFrame {
  ...
  UIBezierPath *strokePath = [UIBezierPath bezierPathWithRoundedRect:guideFrame cornerRadius:8];
